...
export function HeroGeometric({
    ...
    description = "Build exceptional products that users love with our comprehensive component library.",
    children,
}: {
    badge?: string;
    title1?: string;
                ...
                {children ? (
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <motion.div
                            ...
                            animate="visible"
                        >
                            <p className="text-base md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                                {description}
                            </p>
                        </motion.div>
                    </div>
