				...
				>
					<CardContent className="p-8 text-neutral-400 text-sm md:text-lg lg:text-xl leading-relaxed font-light">
						<p>
							...
							<span className="text-amber-400 font-semibold">Full-Stack Developer</span> passionate
							about crafting practical, scalable, and visually appealing web applications.
						</p>
						<p className="mt-4">
							I specialize in{" "}
							<span className="text-pink-400 font-semibold">Next.js and Typescript</span> and love
							solving real problems by blending clean code with thoughtful design. From seamless UIs
							to reliable backends, I enjoy turning ideas into experiences people actually use.
						</p>
					</CardContent>
				</motion.div>
			</motion.section>
