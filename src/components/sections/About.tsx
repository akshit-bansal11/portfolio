          ...
          {elements.map((segment, index) => {
            ...
            return (
              <motion.span
                ...
                animate={
                  inView && isWelcomeComplete ? animateKeyframes : fromSnapshot
                }
      ...
      >
        ...
        >
          <CardContent className="p-8 text-neutral-400 text-sm md:text-lg lg:text-xl leading-relaxed font-light">
            <p>
              Hi, I’m{" "}
              <span className="text-white font-medium">Akshit Bansal</span> — a{" "}
              <span className="text-amber-400 font-semibold">
                Full-Stack Developer
              </span>{" "}
              passionate about crafting practical, scalable, and visually
            ...
            <p className="mt-4">
              ...
              and love solving real problems by blending clean code with
              thoughtful design. From seamless UIs to reliable backends, I enjoy
              turning ideas into experiences people actually use.
            </p>
          </CardContent>
        </motion.div>
      </motion.section>
