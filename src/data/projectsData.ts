...
export const projects: Record<string, ProjectItem[]> = {
  Web: [
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/plotline.png",
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/canopy.png",
      videoUrl:
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/open-tools.png",
      videoUrl:
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/color-space.png",
      videoUrl:
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/influera.png",
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/memory.png",
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/websites/bar-clock.png",
      techStack: ["React", "Tailwind"],
  ...
  Designs: [
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/designs/ipo.webp",
      techStack: ["Figma"],
      designLink:
    ...
    },
    {
      ...
      imgUrl:
        "https://media-server.akshitbansal.me/api/images/portfolio/designs/ecom.webp",
      techStack: ["Figma"],
      designLink:
  ...
  Scripts: [
    ...
    },
    {
      ...
      description:
        "A python script to convert audio files from one format to another.",
      techStack: ["Python"],
      githubLink: "https://github.com/akshit-bansal11/useful-scripts",
      openSource: true,
    },
